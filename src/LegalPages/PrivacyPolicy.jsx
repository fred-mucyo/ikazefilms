    ...
    <main className="legal-main">
      ...
      <Card>
        <CardContent>
          <section className="legal-section">
            <p>
              At <strong>{C.appName}</strong>, we respect your privacy and are committed to
              protecting your personal information. This policy explains what we collect,
              how we use it, and your rights regarding your data.
            </p>

            <h2>1. Information We Collect</h2>
            <ul>
              <li>Account details such as your name, email address, and login data.</li>
              <li>Usage data including pages visited, content viewed, and actions taken.</li>
            ...
            <p>
              ...
              service providers who assist us in operating our platform, or when required by law.
            </p>

            <h2>3.1 Google AdSense and Cookies</h2>
            <p>
              {C.appName} uses <strong>Google AdSense</strong> to display ads. Google uses cookies
              and similar technologies to serve ads based on your previous visits to this and other
              websites. These cookies help deliver relevant advertising and measure ad performance.
            </p>
            <p>
              You can learn more about how Google uses your information by visiting{" "}
              <a
            ...
            <ul>
              ...
              <li>Opt out of cookies, analytics, or marketing communications.</li>
              <li>Withdraw consent for data processing at any time.</li>
            </ul>

            <h2>6. Security</h2>
            <p>
              We implement appropriate safeguards to protect your data. However, no online system
              can be guaranteed to be completely secure.
            </p>

            <h2>7. Children’s Privacy</h2>
            <p>
              {C.appName} is not directed at children under 13. We do not knowingly collect
            ...
            <p>
              ...
              this page, and continued use of our services means you accept the updated policy.
            </p>
